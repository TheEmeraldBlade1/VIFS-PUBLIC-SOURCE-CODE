...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		['bb-panzu',			'bb',				'Ex-Programmer of Psych Engine',								'https://twitter.com/bbpnz213',			0xFF3E813A],
		[''],
		['OS Engine Team'],
		['notweuz_', 'weuz', 'Stage Editor From Os Engine', 'https://twitter.com/notweuz_', 0xFF8633F2],
		[''],
		['Engine Contributors'],
