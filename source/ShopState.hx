...
class ShopState extends MusicBeatState
{
    ...
    var charList:Array<String> = ['none','amongbf','redp','greenp', 'blackp','bfairship', 'bfg', 'bfmira', 'bfpolus', 'bfsauce', 'dripbf', 'pink']; // STOP ADDING TO THIS LIST IM TRYNA GETSHIT WORKING
    ...
    public static var pausemenuEntry:Bool = false;
    ...
    */
    ...
    override function create()
	{
		...
		skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk.cameras = [camUpper];
		add(skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk);
        FlxMouseEventManager.add(skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk, function onMouseDown(s:FlxSprite)
		{
            PlayState.SONG = Song.loadFromJson('skinny-nuts-2-hard', 'skinny-nuts-2');
            PlayState.skinnyNuts2 = true;
            LoadingState.loadAndSwitchState(new PlayState(), true);
            if (pausemenuEntry){
                pausemenuEntry = false;
            }
		}, null, null);

        skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk.y += 250;

        if (!FlxG.save.data.unlockedSkinnyNuts2){
            skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk.visible = false;
        }
    ...
    override function update(elapsed:Float)
    {
        ...
        if(FlxG.keys.justPressed.E && !FlxG.save.data.unlockedSkinnyNuts2){
            FlxG.save.data.unlockedSkinnyNuts2 = true;
            skinnyNuts2TheRealAnywaysTimeTomakeThisVarEXTREMLYLONGfsdklhfgdshlksdfhfghskjfsdjgfhhjgfdskhfjgjkdsajkgljkldfshjfdkdjlfldfsjk.visible = true;
        }
